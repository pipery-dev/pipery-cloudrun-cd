# Pipery Google Cloud Run CD Component

Reusable GitLab CI/CD component for complete Cloud Run deployment pipeline with structured logging.

## Overview

This component provides a complete CD (deployment) pipeline using Google Cloud Run:
- Image/artifact pull
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-cloudrun-cd/catalog-resources/pipery-cloudrun-cd@main
